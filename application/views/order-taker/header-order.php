...
<body>
	...
	<head>
		...
		<link rel='stylesheet' href="<?= base_url('plugins/superfish/css/superfish.css') ?>" type='text/css'
			media='all' />
		<link rel='stylesheet' href="<?= base_url('plugins/dl-menu/component.css') ?>" type='text/css' media='all' />
		<link rel='stylesheet' href="<?= base_url('plugins/font-awesome-new/css/font-awesome.min.css') ?>"
			type='text/css' media='all' />
		<link rel='stylesheet' href="<?= base_url('plugins/fancybox/jquery.fancybox.css') ?>" type='text/css'
			media='all' />
						...
						<div class="top-navigation-right">
							...
							<div class="top-social-wrapper">
								...
								<div class="social-icon">
									<a href="#" target="_blank">
										<img width="32" height="32"
											src="<?= base_url('assets/images/light/social-icon/pinterest.png')?>"
											alt="Pinterest" />
									</a>
								</div>
								<div class="social-icon">
				...
				<div class="gdlr-header-inner">
					<div class="gdlr-header-container container">
						...
						<div class="gdlr-header-container-inner">
							...
							<div class="gdlr-logo">
								<a href="<?= base_url('/')?>">
									<img src="<?= base_url('assets/images/logops.png')?>" alt="" />
								</a>
